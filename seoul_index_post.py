...
def compose(sel, pool):
    ...
    if uses_kobis:
        ...
        if BOXOFFICE_D['en']:
            ...
            scope_ko.append((f'서울 지역 상영, 그날 관객수 상위 {BOXOFFICE_N}편 중',
                             BOXOFFICE_D['ko']))
