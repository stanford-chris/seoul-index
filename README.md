...
| `seoul_index_books_harvest.py` | Monthly harvest of Seoul public-library loan counts into `books_agg.json`, like the sales scan. Currently blocked on key activation (see Data sources). |
